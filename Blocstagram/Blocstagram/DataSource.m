...
- (void) populateDataWithParameters:(NSDictionary *)parameters completionHandler:(NewItemCompletionBloc)completionHandler {
    if (self.accessToken) {
...
-(void) parseDataFromFeedDictionary:(NSDictionary *) feedDictionary fromRequestWithParameters:(NSDictionary *)parameters {
    ...
    if (parameters[@"min_id"]) {
        ...
        // this was an infinate scroll request
        
        if (tmpMediaItems.count == 0) {
            //disable infinate scroll. No older messages
        ...
        [self.instagramOperationManager GET:mediaItem.mediaURL.absoluteString
                                 parameters:nil
                                    success:^(AFHTTPRequestOperation *operation, id responseObject) {
                                        ...
                                        NSLog(@"Error downloadingimage: %@", error);
